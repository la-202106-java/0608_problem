...
宿ID：<input type="number" name="id" value="${planTarget.inn.id}"><br>
プラン内容：<input type="text" name="contents" value="${planTarget.content}"><br>
...
<input type="hidden" name="planid" value="${planTarget.planId}">
</form>
