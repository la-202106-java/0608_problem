...
<body>
	...
	<form action="/0608_problem/ItemServlet" method="post">
		検索：商品名<input type="text" name="name" value = "${searchStr.productName}" > |
		価格<input type="text" name="minPrice" size="5" value = "${searchStr.minPrice}">円以上 <input
			type="text" name="maxPrice" size="5" value = "${searchStr.maxPrice}">円以下の商品を <input
