...
ソート：<a href="/0608_problem/ItemServlet5?action=sort&key=price_asc">値段の低い順</a> ,
<a href="/0608_problem/ItemServlet5?action=sort&key=price_desc">値段の高い順</a><br>

<form action="/0608_problem/ItemServlet5" method="post">
