          ...
          <form class="form-horizontal" onsubmit="return validateForm()" name="form1" action="/0608_problem/KasidasiServlet" method="post">
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                 <input type="email"class="form-control" name="address"value = "${member.address }">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                 <input type="text"class="form-control" name="mail"value = "${member.eMail }">
                </div>
              </div>
              <div class="form-group">
                <label for="inputPassword" class="col-lg-2 control-label">生年月日：</label>
                <div class="col-lg-10">
                 <input type="date" class="form-control" name="birth"value = "${member.birth }">
                  </div>
              </div>
              <div class="form-group">
